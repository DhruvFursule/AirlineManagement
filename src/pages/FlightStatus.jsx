      ...
      (<div className="text-center text-gray-600">No flights available</div>
        ...
        flights.map((flight, index) => (
            <div key={index} className='flex'>
                <div className="h-[180px] w-[50vw] flex mb-4 px-8 items-center rounded-[12px] shadow-lg justify-evenly bg-white">
                ...
                <div className="h-[180px] w-[15vw] bg-white min-w-[203.038px] shadow-lg flex flex-col justify-center items-center rounded-[12px] relative">
